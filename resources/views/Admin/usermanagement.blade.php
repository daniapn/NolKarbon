...
<div class="user-data-section">
    ...
    <tr>
        ...
        <td>
            ...
            <!-- View -->
        <a href="{{ route('admin.readuser', $user->idPengguna) }}" class="action-icon" title="View">
            <svg width="18" height="18" fill="#666" viewBox="0 0 24 24">
                ...
                <!-- Delete -->
               <a href="{{ route('admin.showdeleteuser', $user->idPengguna) }}" class="action-icon" title="Delete">
