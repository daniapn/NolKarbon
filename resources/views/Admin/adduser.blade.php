...
<head>
    ...
    <title>NolKarbon - Add New User</title>
    ...
    <main class="main-content">
        ...
        <div class="content">
            <div class="form-container">
                ...
                <p class="form-subtitle">Fill in the details to create new user</p>
                ...
                <form method="POST" action="{{ route('admin.adduser.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" placeholder="Type your text here" value="{{ old('name') }}" required>
                    </div>

                    <!-- Email -->
                    <div class="form-group">
                        <label for="email">Email <span class="required">*</span></label>
                        <input type="email" id="email" name="email" placeholder="Type your text here" value="{{ old('email') }}" required>
                    </div>

                    <!-- Password -->
                    <div class="form-group">
                        <label for="password">Password <span class="required">*</span></label>
                        <input type="password" id="password" name="password" placeholder="Type your text here" required>
                    </div>

                    <!-- University -->
                    <div class="form-group">
                        <label for="universitas">University <span class="required">*</span></label>
                        <input type="text" id="universitas" name="universitas" placeholder="Type your text here" value="{{ old('universitas') }}" required>
                    </div>
