...
<head>
    ...
    <title>NolKarbon - Tambah Tantangan</title>
    ...
    <main class="main-content">
        ...
        <header class="header">
            <div class="header-left">
                ...
                <p class="header-subtitle">Rancang tantangan baru untuk mendorong aksi ramah lingkungan.</p>
            </div>
        ...
        <!-- Content -->
        <div class="content">
            <a href="{{ route('admin.challenges.index') }}" class="back-link">
            ...
            <section class="challenge-section">
                ...
                <form method="POST" action="{{ route('admin.challenges.store') }}" enctype="multipart/form-data" class="form-layout">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-card-body">
                                ...
                                <div class="form-field">
                                    <label>Slug</label>
                                    <input type="text" name="slug" placeholder="otomatis bila dikosongkan" value="{{ old('slug') }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-card full-width">
                        ...
                        <div class="form-card-body">
                            <div class="form-field">
                                ...
                                <textarea name="description" placeholder="Ceritakan tujuan dan dampak tantangan">{{ old('description') }}</textarea>
                            </div>
                            <div class="form-field">
                                <label>Instruksi Peserta</label>
                                <textarea name="instruction" placeholder="Langkah-langkah, cara melapor, dsb.">{{ old('instruction') }}</textarea>
                            </div>
                            <div class="form-field">
                                <label>Requirement (pisahkan baris)</label>
                                <textarea name="requirement" placeholder="Contoh:&#10;- Upload bukti foto mingguan&#10;- Catat pengurangan emisi">{{ old('requirement') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-card-body">
                            ...
                            <div class="two-cols">
                                <div class="form-field">
                                    ...
                                    <input type="number" name="point_reward" placeholder="0" value="{{ old('point_reward', 0) }}" min="0" required>
                                </div>
                                <div class="form-field">
                                    <label>Bonus Poin</label>
                                    <input type="number" name="bonus_point" placeholder="0" value="{{ old('bonus_point', 0) }}" min="0">
                                </div>
                            </div>
                            ...
                            <div class="two-cols">
                                <div class="form-field">
                                    ...
                                    <input type="text" name="participant_quota" placeholder="Kosongkan jika tidak dibatasi" value="{{ old('participant_quota') }}">
                                </div>
                                <div class="form-field">
                            ...
                            <div class="form-field">
                                ...
                                <div class="status-buttons">
                                    <button type="button" class="status-btn active" data-status="draft">Draft</button>
                                    <button type="button" class="status-btn" data-status="upcoming">Mendatang</button>
                                    <button type="button" class="status-btn" data-status="active">Aktif</button>
                                    <button type="button" class="status-btn" data-status="completed">Selesai</button>
                                    <button type="button" class="status-btn" data-status="archived">Arsip</button>
                                </div>
                    ...
                    <div class="footer-actions">
                        <a href="{{ route('admin.challenges.index') }}" class="btn-cancel">
                            <i class="fas fa-arrow-left"></i> Batal
                        </a>
                        <button type="submit" class="btn-submit">
                            <i class="fas fa-save"></i> Simpan Challenge
                        </button>
                    </div>
                </form>
            </section>
