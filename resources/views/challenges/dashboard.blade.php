...
@section('hero-actions')
    <a href="{{ route('challenge.badges') }}" class="inline-flex items-center gap-2 rounded-full bg-blue-700 px-6 py-3 text-sm font-semibold text-white shadow hover:bg-blue-800">
